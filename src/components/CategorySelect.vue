...
<RouterLink to="library">
    <div
     ...
     class="contrast-[2] brightness-[0.87] rounded-xl aspect-square relative overflow-hidden">
        <div class="text-white pt-3 pl-4 font-semibold text-2xl">{{ category }}</div>
        <img :src="image || ''" class="absolute contrast-[0.55] -right-3.5 bottom-0 max-w-[100px] rotate-[20deg]">
    </div>
</RouterLink> 
</template>
